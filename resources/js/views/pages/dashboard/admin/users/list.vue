                  ...
                  <div class="flex items-center px-4 py-4 sm:px-6">
                    <div class="min-w-0 flex-1 flex items-center">
                      <div class="flex-shrink-0">
                        <img
                          :alt="$t('Avatar')"
                          :src="user.avatar !== 'gravatar' ? user.avatar : user.gravatar"
                      ...
                      <div class="min-w-0 flex-1 px-4 lg:grid lg:grid-cols-2 lg:gap-4">
                        <div>
                          ...
                          >
                            <svg-vue
                              ...
                              icon="font-awesome.envelope-solid"
                            ></svg-vue>
                        ...
                        <div class="hidden lg:block">
                          ...
                          <div class="text-sm leading-5 text-gray-900">
                            {{ $t("User's Company") }}: <b>{{ user.company ? user.company.name : '' }}</b>
                          </div>
                          <div
                            v-show="user.status"
                            class="mt-2 flex items-center text-sm leading-5 text-gray-500"
                          ...
                          >
                            <svg-vue
                              class="flex-shrink-0 mr-1.5 h-4 w-4 text-red-400"
                              icon="font-awesome.times-circle-solid"
                            ></svg-vue>
                            {{ $t("User is disabled") }}
                          </div>
                        </div>
