        ...
        >
          ...
          >
            ...
            <div class="bg-gray-100 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              <button class="btn btn-red mr-2 sm:mr-0" type="button" @click="deleteUser">
                {{ $t("Delete user") }}
              </button>
              <button
...
export default {
  ...
  methods: {
    saveUser() {
      ...
      self.loading = true;
      axios
        .put("api/dashboard/admin/users/" + self.$route.params.id, self.user)
        .then(function () {
          self.loading = false;
          self.$notify({
    ...
    getUser() {
      ...
      self.loading = true;
      axios
        .get("api/dashboard/admin/users/" + self.$route.params.id)
    ...
    deleteUser() {
      const self = this;
      axios
        .delete("api/dashboard/admin/users/" + self.$route.params.id)
        .then(function () {
          self.$notify({
            title: self.$i18n.t("Success").toString(),
    ...
    getUserRoles() {
      const self = this;
      axios
        .get("api/dashboard/admin/users/user-roles")
        .then(function (response) {
    ...
    getCompanies() {
      ...
      self.loading = true;
      axios
        .get("api/dashboard/admin/users/companies")
        .then(function (response) {
