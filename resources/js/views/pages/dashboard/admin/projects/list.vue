              ...
              <div class="relative flex-grow focus-within:z-10">
                ...
                >
                  <svg-vue
                    ...
                    icon="font-awesome.search-regular"
                  ></svg-vue>
                </div>
                <input
                  id="search"
        ...
        <template v-if="projectList.length > 0">
          <ul>
            <template v-for="(project, index) in projectList">
              ...
              >
                <router-link
                  :to="'/dashboard/admin/projects/' + project.id + '/edit'"
                    ...
                    >
                      <div>
                        <div class="text-sm font-medium leading-5 text-gray-900 truncate">
                          {{ $t("Title") }}: {{ project.project_title }}
                        </div>
                        <div class="text-sm font-small leading-5 text-gray-600 truncate">
                          {{ $t("Description") }}: {{ project.description }}
                        </div>
                      </div>
                      <div class="hidden lg:block">
                        <div class="text-sm leading-5 text-gray-900">
                          {{ $t("Company") }}: <b>{{ project.company.name }}</b>
                        </div>
                      </div>
                    </div>
            ...
            <div class="m-auto">
              <div class="grid grid-cols-1 justify-items-center h-full w-full px-4 py-10">
                <div class="flex justify-center items-center">
                  <svg-vue
                    class="h-full h-auto w-64 mb-12"
                    icon="undraw.browsing"
                  ></svg-vue>
                </div>
                <div class="flex justify-center items-center">
    ...
    getProjects() {
      ...
      axios
        ...
        .then(function (response) {
          self.projectList = response.data.items;
