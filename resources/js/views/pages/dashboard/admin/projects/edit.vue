<template>
  <main class="flex-1 relative overflow-y-auto py-6 focus:outline-none" tabindex="0">
    ...
    <div v-show="deleteProjectModal" class="fixed z-20 inset-0 overflow-y-auto">
      <div
      ...
      >
        ...
        >
          <div v-show="deleteProjectModal" class="fixed inset-0 transition-opacity">
          ...
          >
            ...
            <div class="bg-gray-100 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
              ...
              <button
                ...
                type="button"
                @click="deleteProjectModal = false"
              >
                {{ $t("Cancel") }}
              </button>
            </div>
...
export default {
  ...
  metaInfo() {
    return {
      title: this.$i18n.t("Edit project"),
    };
  },
  data() {
    return {
  ...
  methods: {
    saveProject() {
      ...
      self.loading = true;
      axios
        .put("api/dashboard/admin/projects/" + self.$route.params.id, self.project)
    ...
    getProject() {
      ...
      self.loading = true;
      axios
        .get("api/dashboard/admin/projects/" + self.$route.params.id)
        .then(function (response) {
    ...
    deleteProject() {
      const self = this;
      axios
        .delete("api/dashboard/admin/projects/" + self.$route.params.id)
        .then(function () {
          self.$notify({
            title: self.$i18n.t("Success").toString(),
          ...
          self.$router.push("/dashboard/admin/projects");
        })
        .catch(function () {
