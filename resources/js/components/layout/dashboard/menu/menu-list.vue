  ...
  <div>
    ...
    <menu-item
      v-if="
        ...
        $store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.TicketController'
        ]
      "
      :label="$t('Tickets')"
      :mobile="mobile"
    ...
    <menu-item
      v-if="
        $store.state.permissions &&
        $store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.CannedReplyController'
        ]
      "
    ...
    <div
      v-if="
        $store.state.permissions &&
        ($store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.Admin.UserController'
        ] ||
          $store.state.permissions[
            'App.Http.Controllers.Api.Dashboard.Admin.UserRoleController'
          ] ||
          $store.state.permissions[
            'App.Http.Controllers.Api.Dashboard.Admin.SettingController'
          ] ||
          $store.state.permissions[
            'App.Http.Controllers.Api.Dashboard.Admin.LanguageController'
          ] ||
          $store.state.permissions[
            'App.Http.Controllers.Api.Dashboard.Admin.CompanyController'
          ])
      "
    ...
    <menu-item
      v-if="
        $store.state.permissions &&
        $store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.Admin.DepartmentController'
        ]
      "
      :label="$t('Departments')"
      :mobile="mobile"
    ...
    <menu-item
      v-if="
        $store.state.permissions &&
        $store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.Admin.StatusController'
        ]
      "
      :label="$t('Statuses')"
      :mobile="mobile"
    ...
    <menu-item
      v-if="
        $store.state.permissions &&
        $store.state.permissions[
          'App.Http.Controllers.Api.Dashboard.Admin.PriorityController'
        ]
      "
      :label="$t('Priorities')"
      :mobile="mobile"
